...
class VideoMAEEngine:
    def __init__(self):
        ...
        self.processor = AutoImageProcessor.from_pretrained(settings.VIDEOMAE_MODEL_NAME)
        self.model = VideoMAEModel.from_pretrained(settings.VIDEOMAE_MODEL_NAME).to(settings.DEVICE)
        self.model.eval()
